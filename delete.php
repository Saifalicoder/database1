...
body {
 ...
 $invldFlag=0;
  ...
  if (empty($_POST["name"])) {
    ...
    $invalid = test_input($_POST[("invld")]);
}
...
<?php
  ...
  $sql = "DELETE FROM inquiry_table WHERE name = '$name'";
...
if($invldFlag==1){
    ...
    echo "<span class='errorColor errinvi'>$invalid</span>"; 
