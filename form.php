...
<span class="fst"> Name :</span>
  <input type="text"  class="edit" value="<?php if($errorFlag==0)echo "$name"?>">
  
  <br>
  
 <span class="fst"> E-mail :</span>
  <input type="text" class="edit" value="<?php if($errorFlag==0)echo "$email"?>">
  
  <br>
  
 <span class="fst"> Message :</span> <textarea class="edit" rows="6" cols="24"><?php echo "$message"?></textarea>
  <br>
<!-- <?php
echo $emailError;
echo $nameError; ?> -->
...
<?php
if($errorFlag==1){
  echo  "<span class=' err errorColor'>ERROR!</span>";
}
else{
